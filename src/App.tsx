        ...
        <div className="row">
          ...
          <div className="col-sm-4 col-sm-offset-4">
            ...
            <p id="p1">
              ...
              Master of Ceremonies for Clayton County CTAE ceremony in 2023. As
              an honors student, I consistently demonstrate exceptional soft
              skills, including communication, teamwork, and adaptability.
            </p>
            <p id="p1">
              In addition to my academic achievements, I have a strong
              background in management and operations, gained through my
              experience as an Area Supervisor at Chick-fil-A. In this role, I
              developed expertise in team leadership, customer service, and
              organizational efficiency. I have also contributed my skills to
              the community as a Program Supervisor in the Parks and Recreation
              sector, where I played a key role in enhancing recreational
            ...
            <p id="p1">
              ...
              meaningfully to the IT industry. Let&apos;s connect and explore
              how my unique background and enthusiasm can add value to your team
              or project.
            </p>
          </div>
        </div>
